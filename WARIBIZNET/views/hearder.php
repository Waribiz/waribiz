        ...
        <div>
            ...
            <div class="menu">
                ...
                <ul class="list-group">
                    ...
                    <a href="formationFree.php" title="contenu gratuit"><li class="rounded-pill"><span> FORMATION GRATUITE</span></li></a>
                    <a href="views/formations.php" title="formations"><li class="rounded-pill"><span> NOS FORMATIONS</span></li></a>
